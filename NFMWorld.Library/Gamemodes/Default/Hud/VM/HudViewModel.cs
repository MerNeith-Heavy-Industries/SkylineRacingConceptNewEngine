...
public partial class HudViewModel : ObservableObject
{
    ...
    [ObservableProperty]
    public partial float DamageFillAmount { get; set; }

    [ObservableProperty]
    public partial float PowerFillAmount { get; set; }
    
    [ObservableProperty]
    public partial Color DamageColor { get; set; }

    [ObservableProperty]
    public partial Color PowerColor { get; set; }
    ...
    private void UpdatePowerBarColor()
    {
        PowerColor = GetPowerColor(PowerFillAmount);
    }
