...
namespace NFMWorldLibrary.Collision
{
    ...
    public class ConvexHullCalculator
    {
        ...
        ///   adjusted.
        /// </summary>
        private static readonly fix64 EPSILON = (fix64)0.0001f;
        ...
        /// </summary>
        private struct Face(int v0, int v1, int v2, int o0, int o1, int o2, f64Vector3 normal)
        {
            public int Vertex0 = v0;
            public int Vertex1 = v1;
            public int Vertex2 = v2;

            public int Opposite0 = o0;
            public int Opposite1 = o1;
            public int Opposite2 = o2;

            public f64Vector3 Normal = normal;
        ...
        /// </summary>
        private struct PointFace(int p, int f, fix64 d)
        {
            public int Point = p;
            public int Face = f;
            public fix64 Distance = d;
        }
        ...
        public void GenerateHull(
            ReadOnlySpan<f64Vector3> points,
            bool splitVerts,
            List<f64Vector3> verts,
            List<ushort> tris,
            List<f64Vector3>? normals)
        {
            if (points.Length < 4)
            {
            ...
            ExportMesh(points, splitVerts, verts, tris, normals);
            VerifyMesh(points, verts, tris);
        }
        ...
        ///   are initialized.
        /// </summary>
        private void Initialize(ReadOnlySpan<f64Vector3> points, bool splitVerts)
        {
            faceCount = 0;
            openSetTail = -1;
            ...
            else
            {
                ...
                if (openSet.Capacity < points.Length)
                {
                    ...
                    openSet.Capacity = points.Length;
                }
            }
        ...
        /// </summary>
        private void GenerateInitialHull(ReadOnlySpan<f64Vector3> points)
        {
            ...
            var above = Dot(v3 - v1, Cross(v1 - v0, v2 - v0)) > fix64.Zero;
            ...
            for (int i = 0; i < points.Length; i++)
            {
                ...
                openSet!.Add(new PointFace(i, UNASSIGNED, fix64.Zero));
            }

            // Add the seed hull verts to the tail of the list.
            openSet!.Add(new PointFace(b0, INSIDE, fix64.MinValue));
            openSet.Add(new PointFace(b1, INSIDE, fix64.MinValue));
            openSet.Add(new PointFace(b2, INSIDE, fix64.MinValue));
            openSet.Add(new PointFace(b3, INSIDE, fix64.MinValue));
            ...
            Debug.Assert(openSet.Count == points.Length);
        ...
        ///   seed hull
        /// </summary>
        private void FindInitialHullIndices(ReadOnlySpan<f64Vector3> points, out int b0, out int b1, out int b2, out int b3)
        {
        ...
        ///   from its face.
        /// </summary>
        private void GrowHull(ReadOnlySpan<f64Vector3> points)
        {
        ...
        /// </summary>
        private void FindHorizon(ReadOnlySpan<f64Vector3> points, f64Vector3 point, int fi, Face face)
        {
            ...
            Debug.Assert(PointFaceDistance(point, points[face.Vertex0], face) > fix64.Zero);
        ...
        /// </summary>
        private void SearchHorizon(ReadOnlySpan<f64Vector3> points, f64Vector3 point, int prevFaceIndex, int faceCount, Face face)
        {
        ...
        ///   the cone.
        /// </summary>
        private void ConstructCone(ReadOnlySpan<f64Vector3> points, int farthestPoint)
        {
        ...
        /// </summary>
        private void ReassignPoints(ReadOnlySpan<f64Vector3> points)
        {
            for (int i = 0; i <= openSetTail; i++)
            {
                var fp = openSet![i];
        ...
        private static fix64 PointFaceDistance(f64Vector3 point, f64Vector3 pointOnFace, Face face)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static f64Vector3 Normal(f64Vector3 v0, f64Vector3 v1, f64Vector3 v2)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static fix64 Dot(f64Vector3 a, f64Vector3 b)
        {
            return a.X * b.X + a.Y * b.Y + a.Z * b.Z;
        }

        /// <summary>
        ///   f64Vector3.Cross i left-handed, the algorithm is right-handed. Also,
        ///   i wanna test to see if using aggressive inlining makes any
        ///   difference here.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static f64Vector3 Cross(f64Vector3 a, f64Vector3 b)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static bool AreCoincident(f64Vector3 a, f64Vector3 b)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static bool AreCollinear(f64Vector3 a, f64Vector3 b, f64Vector3 c)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static bool AreCoplanar(f64Vector3 a, f64Vector3 b, f64Vector3 c, f64Vector3 d)
        {
        ...
        /// </summary>
        [Conditional("DEBUG")]
        private void VerifyOpenSet(ReadOnlySpan<f64Vector3> points)
        {
            for (int i = 0; i < openSet!.Count; i++)
            {
                ...
                else
                {
                    ...
                    Debug.Assert(PointFaceDistance(
                        ...
                        faces[openSet[i].Face]) > fix64.Zero);
                }
            }
        }
        ...
        /// </summary>
        [Conditional("DEBUG")]
        private void VerifyFaces(ReadOnlySpan<f64Vector3> points)
        {
            foreach (var (fi, face) in faces!)
            {
                ...
                Debug.Assert((face.Normal - Normal(points[face.Vertex0], points[face.Vertex1], points[face.Vertex2])).Length() < EPSILON);
            }
        }
        ...
        /// </summary>
        [Conditional("DEBUG")]
        private static void VerifyMesh(ReadOnlySpan<f64Vector3> points, List<f64Vector3> verts, List<ushort> tris)
        {
            ...
            for (int i = 0; i < points.Length; i++)
            {
                for (int j = 0; j < tris.Count; j += 3)
                {
                    ...
                    Debug.Assert(Dot(points[i] - t0, f64Vector3.Cross(t1 - t0, t2 - t0)) <= EPSILON);
                }
            }
        }
        ...
        ///   debugging.
        /// </summary>
        private static bool HasEdge(in Face f, int e0, int e1)
        {
