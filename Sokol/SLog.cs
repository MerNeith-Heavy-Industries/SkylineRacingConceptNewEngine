...
namespace Sokol
{
    public static unsafe partial class SLog
    {
        ...
        public static void Log(
            ...
            [CallerLineNumber] int line_nr = 0)
        {
#if DEBUG
            ...
            slog_func_native(tag, log_level, 0, message, (uint)line_nr, shortName, null);
#endif
        }
            ...
            [CallerLineNumber] int line_nr = 0)
        {
            ...
            slog_func_native(tag, 3, 0, message, (uint)line_nr, shortName, null);
#endif
        }
            ...
            [CallerLineNumber] int line_nr = 0)
        {
            ...
            slog_func_native(tag, 2, 0, message, (uint)line_nr, shortName, null);
#endif
        }
            ...
            [CallerLineNumber] int line_nr = 0)
        {
            ...
            slog_func_native(tag, 1, 0, message, (uint)line_nr, shortName, null);
#endif
        }
