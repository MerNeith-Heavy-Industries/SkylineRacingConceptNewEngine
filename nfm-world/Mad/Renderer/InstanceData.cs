...
public struct InstanceData(Matrix world, bool getsShadowed = false, float alphaOverride = 1.0f, bool isFullbright = false, bool glow = false) : IEquatable<InstanceData>
{
    ...
    public bool Equals(InstanceData other) =>
        World.Equals(other.World) && AdditionalData.Equals(other.AdditionalData);
